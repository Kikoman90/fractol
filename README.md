...
Several options are available (see [Keyboard shortcuts](https://github.com/Kikoman90/fractol#keyboard-shortcuts) and [Mouse controls](https://github.com/Kikoman90/fractol#mouse-controls) sections for more infos) :
* Zoom and unzoom
